...
const Notification = () => {
  ...
  const { notifications, userChats, allUsers, markAllNotificatonsAsRead, markNotificationAsRead } = useContext(ChatContext);
        ...
        <div className="notifications-box">
          <div className="notifications-header">
            ...
            <div className="mark-as-read"
              onClick={()=>markAllNotificatonsAsRead(notifications)}
            >
              Mark all as read
            </div>
          </div>
